<div>
    ...
    <div class="fixed bg-12 bottom-0 w-full z-30">
        <div class="bg-gray-50 bg-opacity-90 dark:bg-gray-800 flex gap-4 w-4/6 mx-auto items-end px-6 py-4">
            <div class="w-9/12 flex gap-4">
                <div class="flex-1">
                    <div class="text-xs font-medium text-gray-500 mb-1">Name
                        @error('name')
                ...
                <div class="flex-1">
                    <div class="text-xs font-medium text-gray-500 mb-1">Email
                        @error('email')
                        <span class="text-xs text-red-500">(*{{$message}})</span>
                        @enderror
                    </div>
            ...
            <div class="w-3/12">
                ...
                <div x-data="{ showModal : false }">
                    ...
                    <div x-show="showModal" class="fixed text-gray-500 flex items-center justify-center overflow-auto z-50 bg-gray-800 bg-opacity-90 left-0 right-0 top-0 bottom-0" x-transition:enter="transition ease duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <!-- Modal -->
                        <div x-show="showModal" class="bg-white rounded-xl shadow-2xl p-6 sm:w-10/12 md:w-1/2 mx-10" @click.away="showModal = false" x-transition:enter="transition ease duration-100 transform" x-transition:enter-start="opacity-0 scale-90 translate-y-1" x-transition:enter-end="opacity-100 scale-100 translate-y-0" x-transition:leave="transition ease duration-100 transform" x-transition:leave-start="opacity-100 scale-100 translate-y-0" x-transition:leave-end="opacity-0 scale-90 translate-y-1">
                            <!-- Title -->
