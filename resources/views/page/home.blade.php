...
{{--            @foreach($imagen->destino_imagen as $img)--}}
        ...
        <img src="https://s3.us-west-1.amazonaws.com/gotoperu-com/destinations/slider/1709051015344Slider%20copia%203%20nazca_1709051016.jpg" id="Ica"  alt="" class="h-[650px] w-full object-cover info-content Ica">
            ...
            <div class="container mt-12">
                ...
                <div class="w-64 relative mx-auto m-6">
                    <svg
                        ...
                        <g id="PE-AMA" class="departamento " data-name="Amazonas">
                        ...
                        <g id="PE-APU" class="departamento" data-name="Apurímac">
                            <path
                        ...
                        <g class="departamento exists Arequipa" id="PE-ARE" data-name="Arequipa" onclick="showInfo('Arequipa')">
                        ...
                        <g class="departamento exists Ica" id="PE-ICA" data-name="Ica" onclick="showInfo('Ica')">
                            <path
...
@push('scripts')
    ...
    <script>
        ...
        function showInfo(departmentId) {
            ...
            const infoDivId = departmentId;
            const infoDiv = document.getElementsByClassName(infoDivId);
            // if (infoDiv) {
            //     infoDiv.classList.add('active');
            // }
            for (var i = 0; i < infoDiv.length; i++) {
                infoDiv[i].classList.add('active');
            }
        }
