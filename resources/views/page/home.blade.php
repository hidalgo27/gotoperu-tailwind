    ...
    <section class="h-[650px] mt-12 overflow-hidden relative w-full">
        ...
        <div class="absolute bg-gray-950 bg-opacity-30 inset-0">
            <div class="container">
                <div class="w-64 relative">
                    <svg
                        ...
                        <g class="departamento" id="PE-CAJ" data-name="Cajamarca">
                            ...
                            {{--                        <text x="280" y="115" text-anchor="middle" dominant-baseline="central" class="text-xs rotate-45 font-semibold ">Cajamarca</text>--}}
                        </g>
                        <g class="departamento" id="PE-CAL" data-name="El Callao">
                        ...
                        <g class="departamento" id="PE-CUS" data-name="Cusco" onclick="showInfo('PE-CUS')">
                        ...
                        <g class="departamento" id="PE-LIM" data-name="Lima">
                        ...
                        <g class="departamento" id="PE-LMA" data-name="Municipalidad Metropolitana de Lima">
                            <path d="m 196.446,530.304 -0.097,-0.249 -0.445,-2.064 -0.937,-1.303 -1.565,-1.772 -2.466,-2.099 -4.772,-5.25 0.593,-1.054 1.564,-2.011 -0.671,-2.234 -2.01,-3.128 -1.564,-2.682 -0.224,-7.819 -4.419,-0.327 -0.652,-1.863 -1.621,-2.405 1.553,-2.108 2.235,-1.118 2.234,-2.234 2.904,0.671 2.905,2.904 3.351,3.352 3.352,3.351 1.117,2.234 -1.788,0.447 -1.117,3.352 3.129,1.34 2.904,3.352 2.011,3.574 -0.223,5.586 -1.788,3.352 -2.234,2.904 0.446,4.021 z" />
                            {{--                        <text x="189" y="480" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Municipalidad Metropolitana de Lima</text>--}}
                        </g>
                        <g class="departamento" id="PE-LOR" data-name="Loreto">
                            <path
                            ...
                            {{--                        <text x="189" y="480" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Loreto</text>--}}
                        </g>
                        <g class="departamento" id="PE-MDD" data-name="Madre de Dios">
                            <path
                            ...
                            {{--                        <text x="189" y="480" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Madre de Dios</text>--}}
                        </g>
                        <g class="departamento" id="PE-MOQ" data-name="Moquegua">
                            <path
                            ...
                            {{--                        <text x="189" y="480" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Moquegua</text>--}}
                        </g>
                        <g class="departamento" id="PE-PAS" data-name="Pasco">
                            <path
                            ...
                            {{--                        <text x="189" y="480" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Pasco</text>--}}
                        </g>
                        <g class="departamento" id="PE-PIU" data-name="Piura">
                            <path
                        ...
                        <g class="departamento" id="PE-PUN" data-name="Puno">
                            <path
                        ...
                        <g class="departamento" id="PE-SAM" data-name="San Martín">
                            <path
                            ...
                            {{--                        <text x="480" y="630" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">San Martín</text>--}}
                        </g>
                        <g class="departamento" id="PE-TAC" data-name="Tacna">
                            <path
                            ...
                            {{--                        <text x="480" y="630" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Tacna</text>--}}
                        </g>
                        <g class="departamento" id="PE-TUM" data-name="Tumbes">
                            <path
                            ...
                            {{--                        <text x="480" y="630" text-anchor="middle" dominant-baseline="central" class="text-xs font-semibold">Tumbes</text>--}}
                        </g>
                        <g class="departamento" id="PE-UCA" data-name="Ucayali">
                            <path
                        ...
                        <g class="departamento" id="PE-LKT" data-name="Lake Titicaca">
                            <path
                ...
                <div class="grid">
                    <div id="info-PE-AMA" class="info-content">
                        <h2>Amazonas</h2>
                        <p>Información sobre el Amazonas...</p>
                    </div>
                    <div id="info-PE-CUS" class="info-content">
                        <h2>Cusco</h2>
                        <p>Información sobre Cusco...</p>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function showInfo(departmentId) {
            ...
            // Muestra el div relacionado con el departamento clickeado
            const infoDivId = 'info-' + departmentId;
